...
export const metadata: Metadata = {
  title:       "Create Account — Veer Elegance",
  description: "Create your Veer Elegance account and save your details.",
};
...
export default async function SignupPage({
  ...
  // Already authenticated — redirect to requested destination or /account
      ...
      >
        <div style={{ width: "100%", maxWidth: "480px" }}>
          ...
          <p style={{ fontFamily: "var(--font-body), Manrope, sans-serif", fontSize: "0.9375rem", color: "var(--color-espresso-muted)", lineHeight: 1.7, marginBottom: "2.25rem" }}>
            Save your details and make every purchase effortless.
          </p>

          {/* Divider */}
          <div style={{ width: "2rem", height: "1px", background: "var(--color-gold-muted)", marginBottom: "2.25rem" }} aria-hidden="true" />

          <SignupForm initialNext={destination !== "/account" ? destination : undefined} />
        </div>
      </main>
    </div>
  );
